...
# radar carries no value of its own, it reads the distance gauge and the head
# slider by id. Ship one without the other and you get either a scope frozen at
# one bearing or a head with nothing to show for turning.
#
...
P["distance"] = panel("move - Distance test", "DISTANCE", "#ffb020", [
...
P["sound"] = panel("move - Sound test", "SOUND", "#ff5c8a", [
...
P["display"] = panel("move - Display test", "DISPLAY", "#00e5ff", [
...
P["power"] = panel("move - Power test", "POWER", "#3ddc97", [
